...
class UserAdmin(object):
    ...
    list_display = ('username', 'email', 'user_type','mobile','qq_number','is_staff')
    list_filter = ('is_staff', 'is_superuser', 'is_active','username', 'email', 'user_type',)
    search_fields = ('username', 'first_name', 'last_name', 'email','username', 'email', 'user_type',)
    ordering = ('username',)
